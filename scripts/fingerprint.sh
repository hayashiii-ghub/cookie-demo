...
#   marks     the --w each of the 13 doodle marks is holding,
...
capture() {
  ...
  print -r -- "capturing '$label' from $URL"
  {
    ...
    echo "const MARKS='d-njk d-nj d-gem d-att d-arrow2 d-type d-arrow1 d-color d-arrow3 d-layout d-flow d-smile d-star3'.split(' ')"; sleep 1
