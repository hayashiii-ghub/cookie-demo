...
#   marks     the --w each of the 16 doodle marks is holding, the disc highlighter's --hw,
...
capture() {
  ...
  print -r -- "capturing '$label' from $URL"
  {
    ...
    echo "const MARKS='d-njk d-nj d-gem d-att d-arrow2 d-hype d-arrow1 d-song d-cut d-hurt d-flow d-heart2 d-arrow3 d-smile d-star3 d-cookie'.split(' ')"; sleep 1
