...
| `space-mono-latin-{400,700}.woff2` | Space Mono | Google Fonts / Fontsource | OFL 1.1 |
...
The `.woff2` files were fetched once from jsDelivr and committed so the site has
no external font dependency. To refresh, re-download from the sources above.
